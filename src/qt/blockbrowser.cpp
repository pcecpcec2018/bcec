...
{
    if(Height > pindexBest->nHeight) { return "0000097ab10860676f84ebc5fb09d62b3357f85163f76970ab27952e8d1ccb9e"; }
    if(Height < 0) { return "0000097ab10860676f84ebc5fb09d62b3357f85163f76970ab27952e8d1ccb9e"; }
    int desiredheight;
...
{    
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " BCEC");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " BCEC");
    }
}
