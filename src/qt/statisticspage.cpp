...
void StatisticsPage::updateStatistics()
{
    ...
    {
        ui->volumeBox->setText("<b><font color=\"lightgreen\">" + qVolume + " BCEC" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"lightred\">" + qVolume + " BCEC" + "</font></b>");
    } else {
        ui->volumeBox->setText("<b><font color=\"lightblue\">" + qVolume + " BCEC" + "</font></b>");
    }
