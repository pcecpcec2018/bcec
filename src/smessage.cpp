// Copyright (c) 2014 The CreditEmperialCoins developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("CreditEmperialCoins-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("CreditEmperialCoins-smsg-pow"); // Make this thread recognisable
